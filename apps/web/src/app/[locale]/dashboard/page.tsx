    ...
    <div className="flex flex-col gap-16">
      <section>
        <div className="mb-4 flex items-center justify-between">
          <h2 className="font-display text-xl font-bold">{t("recentFavorites")}</h2>
          <Link
      ...
      <section>
        <div className="mb-4 flex items-center justify-between">
          <h2 className="font-display text-xl font-bold">{t("recentScans")}</h2>
          <Link
        ...
        {recentScans.length === 0 ? (
          <p className="text-sm text-muted-foreground">{t("emptyScans")}</p>
        ) : (
